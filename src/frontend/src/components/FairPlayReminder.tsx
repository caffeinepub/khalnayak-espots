...
export function FairPlayReminder({
  ...
  useEffect(() => {
    ...
    const globalDismiss =
      localStorage.getItem("fair-play-dont-show") === "true";
        ...
        <div className="space-y-5">
          <div className="p-4 bg-primary/5 border border-primary/20 rounded-lg">
            <p className="text-sm text-center">
              Did you witness any suspicious activity in{" "}
          ...
          <div className="space-y-3">
            <p className="text-sm text-muted-foreground">
              Our community thrives on fair competition. If you noticed any
              cheating, hacking, or suspicious behavior, please report it.
            </p>
          ...
          <p className="text-xs text-center text-muted-foreground">
            Thank you for helping us maintain a fair and competitive
            environment! 🎮
          </p>
        </div>
      </DialogContent>
