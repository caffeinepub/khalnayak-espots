...
import { Shield, Trophy, DollarSign, Target, AlertTriangle } from "lucide-react";

export function RulesPage() {
  return (
    <div className="container py-12 space-y-8">
      <div>
        <h1 className="text-4xl font-bold font-display mb-2">Rules & Regulations</h1>
        <p className="text-muted-foreground">Complete guide to participating in tournaments</p>
      </div>
      ...
      <Card className="border-secondary/30">
        <CardHeader>
          ...
          <CardDescription>How points are calculated in tournaments</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div>
            <h3 className="font-semibold mb-3">Kill Points</h3>
            <p className="text-muted-foreground mb-2">Each elimination = <span className="text-primary font-bold">1 point</span></p>
          </div>

          <div>
            <h3 className="font-semibold mb-3">Placement Points (Battle Ground Mode)</h3>
            <Table>
              <TableHeader>
                <TableRow>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell><Badge className="bg-primary">12 pts</Badge></TableCell>
                  <TableCell className="font-semibold">6th Place</TableCell>
                  <TableCell><Badge variant="secondary">5 pts</Badge></TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-semibold">2nd Place</TableCell>
                  <TableCell><Badge className="bg-primary">9 pts</Badge></TableCell>
                  <TableCell className="font-semibold">7th Place</TableCell>
                  <TableCell><Badge variant="secondary">4 pts</Badge></TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-semibold">3rd Place</TableCell>
                  <TableCell><Badge className="bg-secondary">8 pts</Badge></TableCell>
                  <TableCell className="font-semibold">8th Place</TableCell>
                  <TableCell><Badge variant="secondary">3 pts</Badge></TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-semibold">4th Place</TableCell>
                  <TableCell><Badge variant="secondary">7 pts</Badge></TableCell>
                  <TableCell className="font-semibold">9th Place</TableCell>
                  <TableCell><Badge variant="secondary">2 pts</Badge></TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="font-semibold">5th Place</TableCell>
                  <TableCell><Badge variant="secondary">6 pts</Badge></TableCell>
                  <TableCell className="font-semibold">10th Place</TableCell>
                  <TableCell><Badge variant="secondary">1 pt</Badge></TableCell>
                </TableRow>
              </TableBody>
            </Table>
            <p className="text-sm text-muted-foreground mt-2">* Ranks 11-48 receive 0 placement points</p>
          </div>

          <div>
            <h3 className="font-semibold mb-2">Total Score Calculation</h3>
            <p className="text-muted-foreground">
              <code className="bg-muted px-2 py-1 rounded">Total Points = Kill Points + Placement Points</code>
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-accent/30">
        <CardHeader>
          ...
          <CardDescription>How winnings are calculated and distributed</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="p-4 bg-primary/5 border border-primary/20 rounded-lg">
            <p className="text-sm text-muted-foreground mb-2">Platform Commission</p>
          ...
          <div className="p-4 bg-accent/5 border border-accent/20 rounded-lg">
            ...
            <p className="text-2xl font-bold text-primary">70% distributed to winners</p>
          </div>
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell className="text-right font-semibold text-primary">35%</TableCell>
                </TableRow>
                <TableRow>
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-muted-foreground">
              ...
              <li>Room ID and password will be shared 15-30 minutes before the match</li>
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          <ul className="list-disc list-inside space-y-2 text-muted-foreground">
            ...
            <li>Entry fee will be deducted automatically upon successful registration</li>
            <li>Registrations are subject to admin approval</li>
            <li>Entry fees are non-refundable once approved (except in case of tournament cancellation)</li>
            <li>If rejected, entry fee will be refunded to your wallet</li>
            <li>Withdraw funds from wallet anytime (subject to admin approval)</li>
