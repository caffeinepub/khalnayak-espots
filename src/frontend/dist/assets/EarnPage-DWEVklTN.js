import { c as createLucideIcon, r as reactExports, af as useOtpAuth, a4 as useTokens, j as jsxRuntimeExports, U as Button, a9 as ue, aa as LoaderCircle } from "./index-Chbj-AOn.js";
import { g as getAdUnitId, A as ADMOB_CONFIG, a as AdModal } from "./AdModal-DayF-FAU.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...rajdhani, color: "#aaa", fontSize: 13 }, children: tokens.canWithdraw ? "✅ Ready! Watch a short ad to redeem ₹1.25 directly to your wallet." : `Need ${tokens.tokensNeeded} more tokens to unlock redemption.` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: "24px 0", color: "#555" }, children: [
