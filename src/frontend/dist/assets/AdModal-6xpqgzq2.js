import { t as createLucideIcon, F as reactExports, j as jsxRuntimeExports } from "./index-DfjncSyi.js";
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-bold text-green-400", children: hideClaimReward ? "Registration Successful! 🎉" : "Ad Complete!" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400 text-sm", children: hideClaimReward ? "You have joined the tournament" : "Claim your reward below" })
                    ] }),
                    !hideClaimReward && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 py-4 rounded-b-2xl bg-zinc-900 border border-zinc-700/50 border-t-0 space-y-3", children: [
          ...
          phase === "claiming" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              style: {
                background: hideClaimReward ? "linear-gradient(135deg, #00FF88, #00cc6a)" : "linear-gradient(135deg, #eab308, #f59e0b)",
                color: "#000",
                boxShadow: hideClaimReward ? "0 0 24px rgba(0,255,136,0.6)" : "0 0 24px rgba(234,179,8,0.6)"
              },
              "data-ocid": "ad.confirm_button",
              children: hideClaimReward ? "✅ Continue" : `🪙 Claim ${rewardLabel}`
            }
          ),
