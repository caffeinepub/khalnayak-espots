import { c as createLucideIcon, ae as useInternetIdentity, r as reactExports, an as useGetCallerTeamRegistrations, w as useGetTournaments, z as useGetTeamRegistrations, j as jsxRuntimeExports, x as Swords, U as Button, ag as Link, G as Card, J as CardContent, V as getTournamentTypeLabel, $ as formatDateTime, K as formatCurrency, T as Trophy, a8 as ue } from "./index-VIWjWtVa.js";
import { B as Badge } from "./badge-BR_kH1hm.js";
import { D as Dialog, b as DialogContent, c as DialogHeader, d as DialogTitle } from "./dialog-DfyzdZfO.js";
...
function FreeMatchCard({
  ...
  const statusColor = status === "Live" ? "bg-yellow-500/20 text-yellow-400 border-yellow-500/30" : "bg-secondary/20 text-secondary border-secondary/30";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold font-display text-base leading-snug truncate", children: match.name }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        ...
        style: isLive ? {
          boxShadow: "0 0 20px oklch(0.75 0.18 195 / 0.3), 0 0 1px oklch(0.75 0.18 195 / 0.6)",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap mb-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    className: isLive ? "bg-primary/20 text-primary border border-primary/40 uppercase text-[10px] tracking-widest" : isCompleted ? "bg-muted text-muted-foreground uppercase text-[10px] tracking-widest" : "bg-secondary/20 text-secondary border border-secondary/40 uppercase text-[10px] tracking-widest",
                    children: isLive ? "🔴 Live" : isCompleted ? "Completed" : "Upcoming"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-base md:text-lg leading-tight truncate", children: tournament.name }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl md:text-4xl font-bold font-display", children: "My Matches" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Your registered tournaments — access room details and results here" })
          ] })
        ] }),
