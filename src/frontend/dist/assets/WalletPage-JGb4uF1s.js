import { c as createLucideIcon, r as reactExports, at as createPopperScope, ai as useDirection, a9 as useControllableState, j as jsxRuntimeExports, au as Root2$2, a8 as createContextScope, aa as useId, ah as createCollection, ae as useComposedRefs, av as Anchor, ab as Primitive, ac as composeEventHandlers, af as useLayoutEffect2, aw as Portal$1, ax as reactDomExports, ay as useCallbackRef, az as hideOthers, aA as useFocusGuards, aB as ReactRemoveScroll, aC as createSlot, aD as FocusScope, aE as DismissableLayer, aF as Content, aG as Arrow, aj as cn, aH as createRovingFocusGroupScope, aI as Root, aJ as Item$1, ad as Presence, aK as useSize, a0 as useGetCallerWallet, Z as useGetCallerUserProfile, C as Card, h as CardHeader, i as CardTitle, a2 as Wallet, k as CardContent, l as formatCurrency, B as Button, p as CardDescription, aL as getTransactionTypeLabel, x as formatDateTime, aM as useDeposit, aN as useWithdraw, aO as useQueryClient, G as Gift, A as TriangleAlert, aP as Smartphone, I as ue } from "./index-DXLNnwaf.js";
import { B as Badge } from "./badge-RVIyFdru.js";
import { D as Dialog, a as DialogTrigger, b as DialogContent, c as DialogHeader, d as DialogTitle, e as DialogDescription } from "./dialog-DY4zO4d6.js";
import { L as Label, I as Input } from "./label-BtxAZz49.js";
import { u as usePrevious } from "./index-CnYX-Ylu.js";
import { V as VISUALLY_HIDDEN_STYLES } from "./index-CiaakU5A.js";
import { C as ChevronDown } from "./chevron-down-D4S8lkjY.js";
import { C as Check } from "./check-DL1iwDGS.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-DqDRx0pN.js";
import { C as CircleCheck } from "./circle-check-ClB7M1Jx.js";
/**
...
const Banknote = createLucideIcon("banknote", __iconNode$9);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function WalletPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container py-12 space-y-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(RedeemCodeSection, { profile }),
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                  ...
                  d.method === "bank" && d.accountHolderName && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground truncate", children: d.accountHolderName }),
...
const PRESET_AMOUNTS = [10, 20, 50, 100, 200, 500, 1e3];
function RedeemCodeSection({
  ...
  const handleSubmit = async (e) => {
    ...
    if (!selectedAmount) {
      ue.error("Please select an amount");
      return;
    }
    ...
    try {
      ...
      const newReq = {
        ...
        username: (profile == null ? void 0 : profile.username) ?? "Unknown User",
        timestamp: Date.now(),
        status: "pending",
        depositRequestId: (_a = depositReq == null ? void 0 : depositReq.id) == null ? void 0 : _a.toString()
      };
      ...
      ue.error((err == null ? void 0 : err.message) || "Failed to submit redeem request");
    } finally {
      setSubmitting(false);
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-green-500/30 bg-gradient-to-br from-green-950/20 to-emerald-900/10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Enter your Google Play gift card code to add balance (Demo Mode)" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-full bg-yellow-500/20 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-8 w-8 text-yellow-400" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-semibold text-yellow-300", children: "Awaiting Admin Approval" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-xs", children: "Your redeem request has been submitted. Admin will review and credit your wallet shortly." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "outline",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Select Amount (₹)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 sm:grid-cols-7 gap-2", children: PRESET_AMOUNTS.map((amt) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            type: "button",
            variant: selectedAmount === amt ? "default" : "outline",
            size: "sm",
            className: selectedAmount === amt ? "bg-green-600 hover:bg-green-700 border-green-500 font-bold" : "border-green-500/30 hover:border-green-400/60 hover:bg-green-950/40",
        ...
        selectedAmount && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-green-400", children: [
          "Selected: ₹",
          selectedAmount,
          " code"
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "redeemCode", children: "Google Play Code" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "redeemCode",
            ...
            className: `font-mono uppercase tracking-widest ${codeError ? "border-destructive focus-visible:ring-destructive" : "border-green-500/30 focus-visible:ring-green-500/50"}`,
            maxLength: 14,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Format: XXXX-XXXX-XXXX (letters and numbers)" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: submitting ? "Submitting..." : "Submit Redeem Request"
        }
      )
    ] }) })
  ] });
...
function DepositDialog({ onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Add Money to Wallet" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Choose your payment method and amount" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "method", children: "Payment Method" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: method, onValueChange: setMethod, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "phonepe", children: "PhonePe" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "googleplay", children: "Google Play Redeem Code" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Note: Actual payment integration is not available in this demo. Submit a request for admin approval." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: [100, 500, 1e3, 2e3].map((preset) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          type: "button",
          variant: "outline",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: depositMutation.isPending ? "Submitting..." : "Submit Request"
        }
      )
    ] })
  ] });
  ...
  const handleSubmit = async (e) => {
    ...
    if (method === "bank") {
      if (!accountNumber.trim() || !ifscCode.trim() || !accountHolderName.trim()) {
        ue.error("Please fill all bank details");
        return;
      }
      if (!/^[A-Z]{4}0[A-Z0-9]{6}$/i.test(ifscCode.trim())) {
        ue.error("Invalid IFSC code format (e.g., HDFC0001234)");
        return;
      }
    }
    try {
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full p-3 rounded-lg bg-muted text-left space-y-1 text-sm", children: [
              ...
              method === "bank" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "A/C No:" }),
                  " ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "form",
      {
        ...
        children: [
              ...
              RadioGroup,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    ...
                    {
                      htmlFor: "method-bank",
                      className: `flex items-center gap-3 p-3 rounded-lg border cursor-pointer transition-colors ${method === "bank" ? "border-yellow-500/60 bg-yellow-500/10" : "border-border hover:border-primary/40 hover:bg-muted/40"}`,
                      "data-ocid": "wallet.withdraw.bank.radio",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(RadioGroupItem, { value: "bank", id: "method-bank" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Banknote, { className: "h-4 w-4 text-yellow-400 flex-shrink-0" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "Bank Transfer (NEFT/IMPS)" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "₹10 – ₹500 · Admin approval required" })
                        ] })
                      ]
                    }
          ...
          method === "bank" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "11-character code (e.g., HDFC0001234)" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
...
export {
  ...
  SelectContent as c,
  SelectItem as d,
  getRedeemRequests as e,
  getMyVouchers as f,
  getWithdrawalDetails as g,
  saveRedeemRequests as h,
  ShoppingBag as i,
  saveMyVouchers as j,
