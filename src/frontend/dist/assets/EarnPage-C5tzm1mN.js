import { F as reactExports, g as useTokens, j as jsxRuntimeExports, s as ue, B as Button, G as LoaderCircle } from "./index-D-73V9ez.js";
import { g as getAdUnitId, A as ADMOB_CONFIG, a as AdModal } from "./AdModal-BOhql862.js";
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: tokens.canWithdraw ? `✅ Ready to withdraw ₹${tokens.RUPEES_PER_WITHDRAWAL.toFixed(2)}!` : `${tokens.tokensNeeded} more tokens to withdraw ₹${tokens.RUPEES_PER_WITHDRAWAL.toFixed(2)}`
                  }
                )
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#333333", fontWeight: 600, fontSize: 15 }, children: "Watch ads to earn tokens!" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#666666", fontSize: 13, marginLeft: 4 }, children: "Only ads watched here give tokens." })
              ]
            }
          ),
...
function WithdrawalSection({
  ...
  const handleComplete = reactExports.useCallback(() => {
    ...
    if (success) {
      ue.success(`✅ ₹${rewardAmount.toFixed(2)} added to your wallet!`, {
        duration: 5e3
      });
    }
  }, [tokens, rewardAmount]);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { ...rajdhani, color: "#666666", fontSize: 13 }, children: tokens.canWithdraw ? `✅ Ready! Watch a short ad to redeem ₹${rewardAmount.toFixed(2)} directly to your wallet.` : `Need ${tokens.tokensNeeded} more tokens to unlock redemption.` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              children: tokens.canWithdraw ? `🎬 WATCH AD TO REDEEM ₹${rewardAmount.toFixed(2)}` : "Collect 25 tokens to redeem"
            }
          ),
