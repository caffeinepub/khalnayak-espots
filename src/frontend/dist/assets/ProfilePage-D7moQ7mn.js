import { u as useUnifiedAuth, a as useIIProfile, b as useNavigate, c as useGetCallerStats, d as useGetCallerTeamRegistrations, e as useGetTournaments, f as useGetTeams, g as useTokens, j as jsxRuntimeExports, C as Card, h as CardContent, B as Button, L as Link, i as LogOut, k as formatCurrency, T as Trophy, l as CardHeader, m as CardTitle, S as SiWhatsapp, n as SiGmail, o as SiInstagram, p as SiFacebook, q as Coins, r as getTournamentStatusLabel, s as ue } from "./index-D-73V9ez.js";
import { B as Badge } from "./badge-B_TwglQj.js";
import { P as Progress } from "./progress-C63aQqMc.js";
import { S as Skeleton } from "./skeleton-DKpiBY4x.js";
import { D as DollarSign, T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-BXWWbQ9y.js";
import { g as getUserReferralStats, a as getReferralSettings } from "./useReferralSettings-NBpWHNqH.js";
import { g as getMyVouchers, C as Copy } from "./WalletPage-BSoDjL4G.js";
import { C as CircleCheck } from "./circle-check-RHmlFu0D.js";
import "./index-DEgO_8Iy.js";
import "./dialog-BsE5ptHi.js";
import "./label-BKFZE3xg.js";
import "./index-FZjftMjb.js";
import "./table-DMUOsBc7.js";
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#888888" }, children: "Nickname" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold", style: { color: "#FFD700" }, children: profile.freefire_nickname || "—" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#888888" }, children: "Level" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold", style: { color: "#FFD700" }, children: profile.freefire_level || "—" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#888888" }, children: "UID" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-mono", style: { color: "#222222" }, children: profile.freefire_uid })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#888888" }, children: "Wallet" }),
          ...
          statsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3 mt-4", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-16 rounded-xl" }, i)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3 mt-4", children: [
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#888888" }, children: label })
              ]
            },
            label
          )) })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#999999", fontSize: 11 }, children: "🔗" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "code",
                    {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  ].map(({ step, icon, text }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "#333333" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs mt-1", style: { color: "#999999" }, children: [
            tokens.balance % 25,
            "/",
            25,
            " to next ₹1.25 redeem"
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "#888888" }, children: [
                  ...
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        ...
                        {
                          style: {
                            background: status === "live" ? "rgba(255,68,68,0.15)" : status === "completed" ? "rgba(0,180,96,0.12)" : "rgba(13,110,253,0.1)",
                            color: status === "live" ? "#CC2222" : status === "completed" ? "#007744" : "#0055CC",
                            border: `1px solid ${status === "live" ? "rgba(204,34,34,0.3)" : status === "completed" ? "rgba(0,119,68,0.25)" : "rgba(0,85,204,0.2)"}`,
                            fontSize: 9,
                            fontWeight: 700,
