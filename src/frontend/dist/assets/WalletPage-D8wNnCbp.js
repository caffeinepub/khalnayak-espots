import { c as createLucideIcon, r as reactExports, aI as createRovingFocusGroupScope, u as useDirection, b as useControllableState, j as jsxRuntimeExports, d as createContextScope, aJ as Root, P as Primitive, g as useComposedRefs, aK as Item, h as composeEventHandlers, av as Presence, v as useSize, t as cn, aA as useGetCallerWallet, aN as useGetCallerUserProfile, ai as useIIProfile, L as Card, M as CardHeader, O as CardTitle, T as CardContent, H as formatCurrency, U as Button, Q as CardDescription, aO as getTransactionTypeLabel, $ as formatDateTime, aP as useDeposit, aQ as useWithdraw, aR as useQueryClient, a7 as Gift, a2 as TriangleAlert, aS as Smartphone, ab as ue } from "./index-VDTIuXJ0.js";
...
function WalletPage() {
  ...
  const copyReferralCode = () => {
    if (iiProfile == null ? void 0 : iiProfile.referral_code) {
      navigator.clipboard.writeText((iiProfile == null ? void 0 : iiProfile.referral_code) || "");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container py-12 space-y-8", children: [
    ...
    (iiProfile == null ? void 0 : iiProfile.referral_code) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "flex-1 bg-[#F5F5F5] border border-[#00FF88]/30 px-4 py-3 rounded-xl font-mono text-lg font-bold text-[#00FF88]", children: iiProfile.referral_code }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
