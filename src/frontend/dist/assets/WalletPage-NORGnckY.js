import { c as createLucideIcon, r as reactExports, aF as createRovingFocusGroupScope, u as useDirection, b as useControllableState, j as jsxRuntimeExports, d as createContextScope, aG as Root, P as Primitive, g as useComposedRefs, aH as Item, h as composeEventHandlers, au as Presence, v as useSize, t as cn, az as useGetCallerWallet, aJ as useGetCallerUserProfile, L as Card, M as CardHeader, O as CardTitle, T as CardContent, H as formatCurrency, U as Button, Q as CardDescription, aK as getTransactionTypeLabel, $ as formatDateTime, aL as useDeposit, aM as useWithdraw, aN as useQueryClient, a7 as Gift, a2 as TriangleAlert, aO as Smartphone, a9 as ue } from "./index-aR9rc9el.js";
...
function WalletPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container py-12 space-y-8", children: [
    ...
    (profile == null ? void 0 : profile.referralCode) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg flex items-center gap-2 text-[#00FF88]", children: "🔗 Referral Code" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "flex-1 bg-[#16213E] border border-[#00FF88]/30 px-4 py-3 rounded-xl font-mono text-lg font-bold text-[#00FF88]", children: profile.referralCode }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
      ...
      Card,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: sortedTransactions.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-[#16213E]", children: [
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-sm text-white", children: [
                    "₹",
                    d.amount.toFixed(2)
                  ] }),
