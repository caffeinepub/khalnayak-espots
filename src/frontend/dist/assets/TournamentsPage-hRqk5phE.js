...
import { t as createLucideIcon, e as useGetTournaments, F as reactExports, j as jsxRuntimeExports, N as getTournamentTypeLabel, s as ue, Q as getTournamentPlayerInfo, k as formatCurrency, L as Link, U as getFreeRegistrationCount, _ as __vitePreload, V as getPaidRegistrationCount, W as saveFreeRegistration } from "./index-D-73V9ez.js";
  ...
  const fetchResults = async () => {
    ...
    try {
      const { collection, query, where, getDocs } = await __vitePreload(async () => {
        const { collection: collection2, query: query2, where: where2, getDocs: getDocs2 } = await import("./index-D-73V9ez.js").then((n) => n.bh);
      ...
      const { getFirebaseDb } = await __vitePreload(async () => {
        const { getFirebaseDb: getFirebaseDb2 } = await import("./index-D-73V9ez.js").then((n) => n.bi);
