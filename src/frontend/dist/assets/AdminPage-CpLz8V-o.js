...
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent, D as DollarSign } from "./tabs-DGBSVGFR.js";
import { u as useGetCheaterFlags, S as ShieldAlert, a as useGetDisqualifiedTeams, b as autoFlagOnScoreEntry, c as banFlaggedPlayer, d as disqualifyTeam, e as clearFlag } from "./useCheaterDetection-Co2CRqLq.js";
import { b as getReferralStats, a as getReferralSettings, s as saveReferralSettings } from "./useReferralSettings-k55txWBA.js";
import { P as Plus, a as getWithdrawalDetails, b as getRedeemRequests, s as saveWithdrawalDetails, g as getMyVouchers, c as saveRedeemRequests } from "./WalletPage-CjK87pmP.js";
import { P as Play } from "./play-BYCEAY_f.js";
import { U as Users } from "./users-Bv-fFa6p.js";
import { Z as Zap } from "./zap-CaP09V0y.js";
import { C as Calendar } from "./calendar-CIL7JOdt.js";
import "./circle-check-BRFTyZdq.js";
/**
    ...
    const fetchFirestoreUsers = async () => {
      try {
        const { collection, getDocs } = await __vitePreload(async () => {
          const { collection: collection2, getDocs: getDocs2 } = await import("./index.esm-C1z4Nc7H.js").then((n) => n.i);
          return { collection: collection2, getDocs: getDocs2 };
        }, true ? __vite__mapDeps([0,1,2]) : void 0);
        const { getFirebaseDb } = await __vitePreload(async () => {
          const { getFirebaseDb: getFirebaseDb2 } = await import("./index-Bq9COV-K.js").then((n) => n.bL);
