import { j as jsxRuntimeExports, ag as useInternetIdentity, ah as useIIProfile, ai as Link, a9 as ue, aj as Bell, ak as User, x as useGetTournaments, al as decodeTournament, H as formatCurrency } from "./index-aR9rc9el.js";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: isLoggedIn ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          "button",
          {
            ...
            style: {
              ...
              background: isLoggingIn ? "rgba(0,255,136,0.3)" : "linear-gradient(135deg, #00FF88 0%, #9d4edd 100%)",
              color: "#FFFFFF",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    style: {
                      ...
                      color: "#FFFFFF",
                      boxShadow: isLoggingIn ? "none" : "0 0 24px rgba(0,255,136,0.4), 0 4px 16px rgba(0,0,0,0.12)",
