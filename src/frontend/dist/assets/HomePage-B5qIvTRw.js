...
import { F as reactExports, j as jsxRuntimeExports, u as useUnifiedAuth, al as getFirebaseDb, am as query, an as orderBy, ao as where, ap as collection, aq as onSnapshot, ar as markNotificationRead, as as markAllNotificationsRead, _ as __vitePreload, b as useNavigate, at as Bell, X, a as useIIProfile, L as Link, au as User, d as useGetCallerTeamRegistrations, e as useGetTournaments, ak as Swords, k as formatCurrency, av as decodeTournament } from "./index-D-73V9ez.js";
      ...
      try {
        ...
        const {
          ...
          const {
            ...
            addDoc: addDoc2
          } = await import("./index-D-73V9ez.js").then((n) => n.bh);
          return {
            getDocs: getDocs2,
            query: fsQuery2,
            where: fsWhere2,
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              ...
              border: isLive ? "1.5px solid rgba(220,53,69,0.50)" : "1.5px solid rgba(0,255,136,0.35)",
              borderRadius: 12,
              padding: "12px 14px",
              display: "flex",
              alignItems: "center",
              justifyContent: "space-between",
              gap: 10,
              boxShadow: isLive ? "0 2px 10px rgba(220,53,69,0.15)" : "0 2px 10px rgba(0,255,136,0.15)"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ...
      (paidRegistrations ?? []).slice(0, 2).map((reg) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              background: isLive ? "rgba(255,68,68,0.04)" : "#F5F5F5",
              border: isLive ? "1.5px solid rgba(220,53,69,0.50)" : "1.5px solid rgba(170,68,255,0.35)",
              borderRadius: 12,
              padding: "12px 14px",
              display: "flex",
              alignItems: "center",
              justifyContent: "space-between",
              gap: 10,
              boxShadow: isLive ? "0 2px 10px rgba(220,53,69,0.15)" : "0 2px 10px rgba(170,68,255,0.15)"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
