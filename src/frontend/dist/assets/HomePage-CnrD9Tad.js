...
function LiveClock() {
  const [formatted, setFormatted] = reactExports.useState(() => formatIST(getISTTime()));
      ...
      try {
        ...
        const {
          ...
          const {
            ...
            addDoc: addDoc2
          } = await import("./index-BWJ5sRq2.js").then((n) => n.bf);
          return {
            getDocs: getDocs2,
            query: fsQuery2,
            where: fsWhere2,
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        children: getNotifIcon(notif.type)
                      }
                    ),
