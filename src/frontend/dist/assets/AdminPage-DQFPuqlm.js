const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dialog-BFArhm5Q.js","assets/index-CHYy-HWx.js","assets/index-ZTPqfFfr.css"])))=>i.map(i=>d[i]);
import { w as createLucideIcon, A as reactExports, j as jsxRuntimeExports, P as Primitive, ap as createPopperScope, a7 as useDirection, Q as useControllableState, aq as Root2$1, N as createContextScope, a8 as useId, af as createCollection, R as useComposedRefs, ar as Anchor, V as composeEventHandlers, ad as useLayoutEffect2, as as Portal$1, at as reactDomExports, au as useCallbackRef, av as hideOthers, aw as useFocusGuards, ax as ReactRemoveScroll, ay as createSlot, az as FocusScope, aA as DismissableLayer, aB as Content, aC as Arrow, x as cn, W as useSize, aD as useIsCallerAdmin, aE as Navigate, G as Shield, d as useGetTournaments, ac as Swords, aF as useGetPlatformStats, a1 as useGetTeamRegistrations, aG as useGetDepositRequests, aH as useGetWithdrawalRequests, f as formatCurrency, i as useGetTeams, aI as useApproveTeamRegistration, aJ as useRejectTeamRegistration, C as Card, o as CardHeader, p as CardTitle, F as CardDescription, l as CardContent, m as Button, X, I as getTournamentTypeLabel, v as getTournamentStatusLabel, aK as useApproveDeposit, aL as useRejectDeposit, aj as formatDateTime, aM as useApproveWithdrawal, aN as useRejectWithdrawal, H as TriangleAlert, aO as useGetAllUsers, k as useTokens, T as Trophy, t as Coins, an as Gift, aP as getFreeRegistrations, aQ as getPaidRegistrations, aR as useUpdateTournamentStatus, aS as useUpdateTournamentRoomCredentials, c as ue, D as LoaderCircle, aT as useCreateTournament, aU as useDistributePrizes, aV as useUpdateTeamScore, _ as __vitePreload, aW as RefreshCw } from "./index-CHYy-HWx.js";
import { B as Badge } from "./badge-DIzEaKGk.js";
import { D as Dialog, e as DialogTrigger, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription } from "./dialog-BFArhm5Q.js";
import { L as Label, I as Input } from "./label-CKeGbmZX.js";
import { P as Progress } from "./progress-DDO6r7Qn.js";
import { u as usePrevious } from "./index-C90eBDjK.js";
import { C as ChevronDown } from "./chevron-down-Bc_HdstL.js";
import { C as Check } from "./check-CdZDjVco.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-CzhfSCsG.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent, D as DollarSign } from "./tabs-Dqj06DnN.js";
import { S as ShieldAlert, u as useGetCheaterFlags, a as useGetDisqualifiedTeams, b as banFlaggedPlayer, d as disqualifyTeam, c as clearFlag, e as autoFlagOnScoreEntry } from "./useCheaterDetection-Dp_9VeAJ.js";
import { b as getReferralStats, a as getReferralSettings, s as saveReferralSettings } from "./useReferralSettings-B4XC9lVR.js";
import { P as Plus, a as getWithdrawalDetails, b as getRedeemRequests, s as saveWithdrawalDetails, g as getMyVouchers, c as saveRedeemRequests } from "./WalletPage-CcP0eXjE.js";
import { P as Play } from "./play-Dxx89JGZ.js";
import { U as Users } from "./users-7VnEgiGc.js";
import { Z as Zap } from "./zap-UJ5qAOjN.js";
import { C as Calendar } from "./calendar-DEzZ62Ei.js";
import "./circle-check-DvkJeog6.js";
/**
...
function FreeTournamentsInMatchesSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 mt-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 sm:grid-cols-2", children: tournaments.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      DynamicFreeTournamentAdminCard,
      {
        id: t.id,
        data: t.data,
...
function ManageMatchesTab() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(FreeTournamentsInMatchesSection, {})
  ] });
}
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { collection, addDoc } = await __vitePreload(async () => {
        const { collection: collection2, addDoc: addDoc2 } = await import("./dialog-BFArhm5Q.js").then((n) => n.i);
        return { collection: collection2, addDoc: addDoc2 };
      }, true ? __vite__mapDeps([0,1,2]) : void 0);
      const { getFirebaseDb } = await __vitePreload(async () => {
        const { getFirebaseDb: getFirebaseDb2 } = await import("./index-CHYy-HWx.js").then((n) => n.bL);
    ...
    const fetchFirestoreUsers = async () => {
      try {
        const { collection, getDocs } = await __vitePreload(async () => {
          const { collection: collection2, getDocs: getDocs2 } = await import("./dialog-BFArhm5Q.js").then((n) => n.i);
