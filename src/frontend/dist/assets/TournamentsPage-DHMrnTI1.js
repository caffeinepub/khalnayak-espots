...
import { t as createLucideIcon, e as useGetTournaments, F as reactExports, j as jsxRuntimeExports, M as getTournamentTypeLabel, s as ue, N as getTournamentPlayerInfo, k as formatCurrency, L as Link, Q as getFreeRegistrationCount, _ as __vitePreload, U as getPaidRegistrationCount, V as saveFreeRegistration } from "./index-CFrAl5eX.js";
  ...
  const fetchResults = async () => {
    ...
    try {
      const { collection, query, where, getDocs } = await __vitePreload(async () => {
        const { collection: collection2, query: query2, where: where2, getDocs: getDocs2 } = await import("./index-CFrAl5eX.js").then((n) => n.bg);
      ...
      const { getFirebaseDb } = await __vitePreload(async () => {
        const { getFirebaseDb: getFirebaseDb2 } = await import("./index-CFrAl5eX.js").then((n) => n.bh);
