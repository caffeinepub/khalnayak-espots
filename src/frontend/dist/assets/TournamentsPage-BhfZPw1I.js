import { c as createLucideIcon, a as useGetTournaments, r as reactExports, j as jsxRuntimeExports, q as getTournamentTypeLabel, I as ue, ap as getTournamentPlayerInfo, l as formatCurrency, Q as Link, E as useTokens } from "./index-DXLNnwaf.js";
import { C as CountdownTimer, I as InterstitialOverlay } from "./CountdownTimer-_01S83f1.js";
import { a as AdModal } from "./AdModal-RJ42nA-D.js";
import { C as Checkbox } from "./checkbox-u9F_vPVW.js";
import { D as Dialog, b as DialogContent, c as DialogHeader, d as DialogTitle, e as DialogDescription } from "./dialog-DY4zO4d6.js";
import { L as Label, I as Input } from "./label-BtxAZz49.js";
import { S as Skeleton } from "./skeleton-pC-H_lxg.js";
import { U as Users } from "./users-Da71c17V.js";
import { C as Calendar } from "./calendar-DsFj5qsF.js";
import "./progress-DRsgvwvj.js";
import "./play-CPyrF83a.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        onMouseEnter: (e) => {
          e.currentTarget.style.boxShadow = `0 8px 32px ${accent}33, 0 4px 20px rgba(0,0,0,0.5)`;
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  style: {
                    background: isSolo ? "rgba(255,215,0,0.12)" : "rgba(0,255,136,0.12)",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: {
                  background: isFull ? "rgba(255,50,50,0.1)" : "rgba(0,255,136,0.07)",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  style: {
                    background: matchStarted ? "linear-gradient(135deg, #ffd700, #ff8c00)" : "rgba(255,255,255,0.06)",
                    color: matchStarted ? "#0A0A0A" : "rgba(255,255,255,0.25)",
                    border: matchStarted ? "1px solid #ffd700" : "1px solid rgba(255,255,255,0.1)",
                    boxShadow: matchStarted ? "0 0 12px rgba(255,215,0,0.5)" : "none",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                style: {
                  background: isFull ? "rgba(255,255,255,0.08)" : `linear-gradient(135deg, ${accent}, #00cc6a)`,
                ...
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "rgba(255,255,255,0.5)", fontSize: 13 }, children: "Room ID" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-bold text-white", children: roomId })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "rgba(255,255,255,0.5)", fontSize: 13 }, children: "Password" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-bold text-white", children: roomPassword || "—" })
                    ] })
                  ]
                }
              ),
...
function TournamentsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen pb-24", style: { background: "#0A0A0A" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container py-8 space-y-6 px-4 md:px-6", children: [
    ...
    section === "free" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5", children: FREE_TOURNAMENTS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(FreeTournamentCard, { t }, t.id)) })
    ] }),
