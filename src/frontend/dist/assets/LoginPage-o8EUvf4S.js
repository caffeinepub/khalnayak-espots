import { af as useUnifiedAuth, r as reactExports, j as jsxRuntimeExports, U as Button, aa as LoaderCircle } from "./index-eWVd2Qjl.js";
...
function LoginPage() {
  ...
  const handleIILogin = () => {
    setIiLoading(true);
    loginWithII();
    setTimeout(() => setIiLoading(false), 3e3);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    ...
                    style: {
                      ...
                      justifyContent: "center",
                      gap: 10,
                      background: iiLoading ? "rgba(157,78,221,0.08)" : "rgba(157,78,221,0.12)",
                    ...
                    children: [
                      iiLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                        LoaderCircle,
                        {
                          className: "h-4 w-4 animate-spin",
                          style: { color: "#9d4edd" }
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "Internet Identity uses Face ID / Fingerprint — no password needed"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "•" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🌐 Blockchain" })
                    ]
                  }
                )
              ] })
