...
import { w as createLucideIcon, d as useGetTournaments, A as reactExports, j as jsxRuntimeExports, I as getTournamentTypeLabel, c as ue, J as getTournamentPlayerInfo, f as formatCurrency, L as Link, _ as __vitePreload, K as saveFreeRegistration } from "./index-CfQltBJh.js";
  ...
  const fetchResults = async () => {
    ...
    try {
      const { collection, query, where, getDocs } = await __vitePreload(async () => {
        const { collection: collection2, query: query2, where: where2, getDocs: getDocs2 } = await import("./dialog-D5wCscSW.js").then((n) => n.i);
