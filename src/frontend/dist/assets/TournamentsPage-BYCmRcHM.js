  ...
  const fetchResults = async () => {
    ...
    try {
      const { collection, query, where, getDocs } = await __vitePreload(async () => {
        const { collection: collection2, query: query2, where: where2, getDocs: getDocs2 } = await import("./index-DfjncSyi.js").then((n) => n.bg);
      ...
      const { getFirebaseDb } = await __vitePreload(async () => {
        const { getFirebaseDb: getFirebaseDb2 } = await import("./index-DfjncSyi.js").then((n) => n.bh);
