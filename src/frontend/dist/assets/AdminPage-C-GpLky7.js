...
import { y as createLucideIcon, r as reactExports, j as jsxRuntimeExports, R as Primitive, ar as createPopperScope, aa as useDirection, W as useControllableState, as as Root2$1, Q as createContextScope, ab as useId, ah as createCollection, Y as useComposedRefs, at as Anchor, Z as composeEventHandlers, af as useLayoutEffect2, au as Portal$1, av as reactDomExports, aw as useCallbackRef, ax as hideOthers, ay as useFocusGuards, az as ReactRemoveScroll, aA as createSlot, aB as FocusScope, aC as DismissableLayer, aD as Content, aE as Arrow, z as cn, $ as useSize, aF as useIsCallerAdmin, aG as Navigate, H as Shield, e as useGetTournaments, S as Swords, aH as useGetPlatformStats, a4 as useGetTeamRegistrations, aI as useGetDepositRequests, aJ as useGetWithdrawalRequests, f as formatCurrency, i as useGetTeams, aK as useApproveTeamRegistration, aL as useRejectTeamRegistration, C as Card, o as CardHeader, p as CardTitle, G as CardDescription, l as CardContent, m as Button, X, J as getTournamentTypeLabel, x as getTournamentStatusLabel, aM as useApproveDeposit, aN as useRejectDeposit, al as formatDateTime, aO as useApproveWithdrawal, aP as useRejectWithdrawal, I as TriangleAlert, aQ as useGetAllUsers, k as useTokens, T as Trophy, w as Coins, ap as Gift, aR as getFreeRegistrations, aS as getPaidRegistrations, c as ue, aT as useCreateTournament, aU as useUpdateTournamentStatus, aV as useUpdateTournamentRoomCredentials, aW as useDistributePrizes, aX as useUpdateTeamScore, _ as __vitePreload, E as LoaderCircle, aY as RefreshCw } from "./index-BY_LkDWL.js";
import { B as Badge } from "./badge-DMSwn40q.js";
import { D as Dialog, e as DialogTrigger, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogDescription } from "./dialog-BlEBj48f.js";
import { L as Label, I as Input } from "./label-BKLRe-ZD.js";
import { P as Progress } from "./progress-4ElVZwMV.js";
import { u as usePrevious } from "./index-DS9lFAqv.js";
import { C as ChevronDown } from "./chevron-down-C4m9TR5W.js";
import { C as Check } from "./check-_lBHdqld.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-B9I4_Wtd.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent, D as DollarSign } from "./tabs-Bk9eJEFD.js";
import { S as ShieldAlert, u as useGetCheaterFlags, a as useGetDisqualifiedTeams, b as banFlaggedPlayer, d as disqualifyTeam, c as clearFlag, e as autoFlagOnScoreEntry } from "./useCheaterDetection-CVRo_C2v.js";
import { b as getReferralStats, a as getReferralSettings, s as saveReferralSettings } from "./useReferralSettings-uH7Nb25r.js";
import { P as Plus, a as getWithdrawalDetails, b as getRedeemRequests, s as saveWithdrawalDetails, g as getMyVouchers, c as saveRedeemRequests } from "./WalletPage-Dp9m84Kb.js";
import { P as Play } from "./play-C_Embanc.js";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { collection, addDoc } = await __vitePreload(async () => {
        const { collection: collection2, addDoc: addDoc2 } = await import("./dialog-BlEBj48f.js").then((n) => n.i);
...
function UsersTab() {
  ...
  reactExports.useEffect(() => {
    const fetchFirestoreUsers = async () => {
      try {
        const { collection, getDocs } = await __vitePreload(async () => {
          const { collection: collection2, getDocs: getDocs2 } = await import("./dialog-BlEBj48f.js").then((n) => n.i);
          return { collection: collection2, getDocs: getDocs2 };
        }, true ? __vite__mapDeps([0,1,2]) : void 0);
        const { getFirebaseDb } = await __vitePreload(async () => {
          const { getFirebaseDb: getFirebaseDb2 } = await import("./index-BY_LkDWL.js").then((n) => n.bN);
          return { getFirebaseDb: getFirebaseDb2 };
